...
namespace UKControllerPluginTest::Releases {
    ...
    class ReleaseModuleTest : public Test
    {
        ...
        ReleaseModuleTest()
        {
            ...
            ON_CALL(this->dependencyLoader, LoadDependency("DEPENDENCY_ENROUTE_RELEASE_TYPES", nlohmann::json::array()))
    ...
    TEST_F(ReleaseModuleTest, ItRegistersDepartureReleaseRequestEventHandlerCollectionWithContainer)
    {
        BootstrapPlugin(this->container, this->plugin, this->dependencyLoader);
        EXPECT_EQ(0, this->container.releaseRequestHandlers->CountHandlers());
    }
} // namespace UKControllerPluginTest::Releases
